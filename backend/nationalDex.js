// The National Pokédex, #1 (Bulbasaur) through #1025 (Pecharunt) — index 0 is #1.
// Generated from PokeAPI's /pokemon-species list (species order = national dex order),
// with a handful of display-name corrections PokeAPI's lowercase-hyphenated slugs lose
// (apostrophes, periods, colons, gender symbols, accents, and hyphens that are part of
// the actual name rather than a word-separator).
